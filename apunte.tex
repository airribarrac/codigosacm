...
\end{titlepage}	
	...
	\section{Sparse Table}
		\lstinputlisting{Estructuras/sparsetable.cpp}
	...
	\section{Algoritmo de Gausss}
		\lstinputlisting{Math/gaussianelimination.cpp}
	\chapter{Geometria}
	...
	\lstinputlisting{Geometria/distPointLine.cpp}
	\section{Distancia punto-segmento}
	\lstinputlisting{Geometria/distPointSegment.cpp}
	\section{Check if convex}
	\lstinputlisting{Geometria/convexCheck.cpp}
	\chapter{Flujo}
...
\section{Dinic}
	...
	\chapter{Misc}
	\section{Fechas}
	\lstinputlisting{Misc/dates.cpp}
	\section{Inversion Count}
	\lstinputlisting{Misc/inversioncount.cpp}
	\section{Longest palindrome subsequence}
	\lstinputlisting{DP/longestpalindromesubsequence.cpp}
